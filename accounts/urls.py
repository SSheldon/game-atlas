...
urlpatterns = patterns('',
    ...
    url(r'^games/remove/$', 'lists.views.remove_game', name='remove_game'),
    url(r'^games/recommended/$', 'lists.views.recommended_games', name='recommended_games'),
    url(r'^games/import/steam/$', 'lists.views.import_steam_games', name='import_steam_games'),
    url(r'^games/import/xbox/$', 'lists.views.import_xbox_games', name='import_xbox_games'),
